...
public class RecurrentFutureTest {
  ...
  public void testListenersForSuccessfulCompletion() throws Throwable {
    ...
    // When
    registerListeners(Recurrent.get(callable, new RetryPolicy().retryFor(false), executor));
    waiter.await(1000, 6);
  ...
  public void testListenersForFailureCompletion() throws Throwable {
    ...
    // When
    registerListeners(Recurrent.get(callable, new RetryPolicy().retryFor(false).withMaxRetries(3), executor));
    waiter.await(1000, 6);
